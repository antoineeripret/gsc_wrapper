...
|Required dimensions|Required metrics| Output|BQ ready|
|:----|:----|:----|:----|
|page / date |clicks or impressions | pd.DataFrame|:white_check_mark:|
...
|Required dimensions|Required metrics| Output|BQ ready|
|:----|:----|:----|:----|
|query / page | None |pd.DataFrame|:white_check_mark:|
...
|Required dimensions|Required metrics| Output|BQ ready|
|:----|:----|:----|:----|
|page (or query) and date | None |pd.DataFrame|:x:|
...
|Required dimensions|Required metrics| Output|BQ ready|
|:----|:----|:----|:----|
|query | clicks / impressions |pd.DataFrame|:x:|
